...
def table():
    ...
    if mode == 'comparison':
        ...
        filenames = [
            'result/c101/lem.txt', 'result/c101/moea.txt', 'result/c101/dbmoea.txt',
            'result/c201/lem.txt', 'result/c201/moea.txt', 'result/c201/dbmoea.txt',
            'result/r101/lem.txt', 'result/r101/moea.txt', 'result/r101/dbmoea.txt',
            'result/r201/lem.txt', 'result/r201/moea.txt', 'result/r201/dbmoea.txt',
            'result/rc101/lem.txt', 'result/rc101/moea.txt', 'result/rc101/dbmoea.txt',
            'result/rc201/lem.txt', 'result/rc201/moea.txt', 'result/rc201/dbmoea.txt']
        ...
        filenames = [
            'result/c101/lem.txt', 'result/c101/lemNoL.txt',
            'result/c201/lem.txt', 'result/c201/lemNoL.txt',
            'result/r101/lem.txt', 'result/r101/lemNoL.txt',
            'result/r201/lem.txt', 'result/r201/lemNoL.txt',
            'result/rc101/lem.txt', 'result/rc101/lemNoL.txt',
            'result/rc201/lem.txt', 'result/rc201/lemNoL.txt']
